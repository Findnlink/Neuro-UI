...
function animateChildren(visualElement2, variant, delayChildren, staggerChildren, staggerDirection, options) {
  ...
  Array.from(visualElement2.variantChildren).sort(sortByTreeOrder).forEach(function(child2, i) {
    animations2.push(animateVariant(child2, variant, __assign$1(__assign$1({}, options), { delay: delayChildren + generateStaggerDuration(i) })).then(function() {
...
var getChildKey = function(child2) {
  return child2.key || "";
};
function updateChildLookup(children, allChildren) {
  children.forEach(function(child2) {
    var key = getChildKey(child2);
    allChildren.set(key, child2);
  });
}
function onlyElements(children) {
  var filtered = [];
  Children.forEach(children, function(child2) {
    if (isValidElement(child2))
      filtered.push(child2);
  });
  return filtered;
}
var AnimatePresence = function(_a) {
  ...
  if (isInitialRender.current) {
    return React$1.createElement(React$1.Fragment, null, childrenToRender.map(function(child2) {
      return React$1.createElement(PresenceChild, { key: getChildKey(child2), isPresent: true, initial: initial ? void 0 : false, presenceAffectsLayout }, child2);
    }));
  }
  ...
  exiting.forEach(function(key2) {
    if (targetKeys.indexOf(key2) !== -1)
      return;
    var child2 = allChildren.get(key2);
    if (!child2)
      return;
    ...
    childrenToRender.splice(insertionIndex, 0, React$1.createElement(PresenceChild, { key: getChildKey(child2), isPresent: false, onExitComplete: onExit, custom, presenceAffectsLayout }, child2));
  });
  childrenToRender = childrenToRender.map(function(child2) {
    var key2 = child2.key;
    return exiting.has(key2) ? child2 : React$1.createElement(PresenceChild, { key: getChildKey(child2), isPresent: true, presenceAffectsLayout }, child2);
  });
  return React$1.createElement(React$1.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map(function(child2) {
...
function ComponentWrapper(_o) {
  ...
  const addPropsToChildren = (children2, props22) => {
    const addPropsToChild = (child2, props3) => {
      if (React__default.isValidElement(child2)) {
        return React__default.cloneElement(child2, props3);
      } else {
        console.log("ComponentWrapper: Invalid element: ", child2);
        return child2;
      }
    };
    if (Array.isArray(children2)) {
      return children2.map((child2, ix) => addPropsToChild(child2, __spreadValues({ key: ix }, props22)));
    } else {
...
var getReorderImpact = function(_ref2) {
  ...
  var withoutDragging = removeDraggableFromList(draggable2, insideDestination);
  var closest3 = find(withoutDragging, function(child2) {
    var id2 = child2.descriptor.id;
    var childCenter = child2.page.borderBox.center[axis.line];
...
var getCombineImpact = function(_ref) {
  ...
  var targetEnd = targetRect[axis.end];
  var withoutDragging = removeDraggableFromList(draggable2, insideDestination);
  var combineWith = find(withoutDragging, function(child2) {
    var id2 = child2.descriptor.id;
    var childRect = child2.page.borderBox;
...
const modal = "_modal_1o6ll_1";
const open$2 = "_open_1o6ll_17";
const inner = "_inner_1o6ll_20";
const closed = "_closed_1o6ll_24";
const child = "_child_1o6ll_44";
const close$2 = "_close_1o6ll_24";
const confirm = "_confirm_1o6ll_64";
const buttonWrapper = "_buttonWrapper_1o6ll_84";
const noWrap = "_noWrap_1o6ll_87";
var scss$h = {
  modal,
  open: open$2,
  inner,
...
const fontS$1 = "_fontS_1ahxr_1";
const fontM$1 = "_fontM_1ahxr_6";
const fontL$1 = "_fontL_1ahxr_11";
const fontXL$1 = "_fontXL_1ahxr_16";
const weightLight$1 = "_weightLight_1ahxr_21";
const weightNormal$1 = "_weightNormal_1ahxr_26";
const weightBold$1 = "_weightBold_1ahxr_31";
const disabled$1 = "_disabled_1ahxr_36";
const error$1 = "_error_1ahxr_45";
const errorMessage$1 = "_errorMessage_1ahxr_49";
const pointer$1 = "_pointer_1ahxr_54";
const loading$1 = "_loading_1ahxr_58";
const loadingAnimationOpacity$1 = "_loadingAnimationOpacity_1ahxr_1";
const loadingAnimation$1 = "_loadingAnimation_1ahxr_1";
const margin0$1 = "_margin0_1ahxr_94";
const marginS$1 = "_marginS_1ahxr_98";
const marginM$1 = "_marginM_1ahxr_102";
const marginL$1 = "_marginL_1ahxr_106";
const marginXL$1 = "_marginXL_1ahxr_110";
const marginTop0$1 = "_marginTop0_1ahxr_114";
const marginTopS$1 = "_marginTopS_1ahxr_118";
const marginTopM$1 = "_marginTopM_1ahxr_122";
const marginTopL$1 = "_marginTopL_1ahxr_126";
const marginTopXL$1 = "_marginTopXL_1ahxr_130";
const marginRight0$1 = "_marginRight0_1ahxr_134";
const marginRightS$1 = "_marginRightS_1ahxr_138";
const marginRightM$1 = "_marginRightM_1ahxr_142";
const marginRightL$1 = "_marginRightL_1ahxr_146";
const marginRightXL$1 = "_marginRightXL_1ahxr_150";
const marginBottom0$1 = "_marginBottom0_1ahxr_154";
const marginBottomS$1 = "_marginBottomS_1ahxr_158";
const marginBottomM$1 = "_marginBottomM_1ahxr_162";
const marginBottomL$1 = "_marginBottomL_1ahxr_166";
const marginBottomXL$1 = "_marginBottomXL_1ahxr_170";
const marginLeft0$1 = "_marginLeft0_1ahxr_174";
const marginLeftS$1 = "_marginLeftS_1ahxr_178";
const marginLeftM$1 = "_marginLeftM_1ahxr_182";
const marginLeftL$1 = "_marginLeftL_1ahxr_186";
const marginLeftXL$1 = "_marginLeftXL_1ahxr_190";
const padding0$1 = "_padding0_1ahxr_194";
const paddingS$1 = "_paddingS_1ahxr_198";
const paddingM$1 = "_paddingM_1ahxr_202";
const paddingL$1 = "_paddingL_1ahxr_206";
const paddingXL$1 = "_paddingXL_1ahxr_210";
const paddingTop0$1 = "_paddingTop0_1ahxr_214";
const paddingTopS$1 = "_paddingTopS_1ahxr_218";
const paddingTopM$1 = "_paddingTopM_1ahxr_222";
const paddingTopL$1 = "_paddingTopL_1ahxr_226";
const paddingTopXL$1 = "_paddingTopXL_1ahxr_230";
const paddingRight0$1 = "_paddingRight0_1ahxr_234";
const paddingRightS$1 = "_paddingRightS_1ahxr_238";
const paddingRightM$1 = "_paddingRightM_1ahxr_242";
const paddingRightL$1 = "_paddingRightL_1ahxr_246";
const paddingRightXL$1 = "_paddingRightXL_1ahxr_250";
const paddingBottom0$1 = "_paddingBottom0_1ahxr_254";
const paddingBottomS$1 = "_paddingBottomS_1ahxr_258";
const paddingBottomM$1 = "_paddingBottomM_1ahxr_262";
const paddingBottomL$1 = "_paddingBottomL_1ahxr_266";
const paddingBottomXL$1 = "_paddingBottomXL_1ahxr_270";
const paddingLeft0$1 = "_paddingLeft0_1ahxr_274";
const paddingLeftS$1 = "_paddingLeftS_1ahxr_278";
const paddingLeftM$1 = "_paddingLeftM_1ahxr_282";
const paddingLeftL$1 = "_paddingLeftL_1ahxr_286";
const paddingLeftXL$1 = "_paddingLeftXL_1ahxr_290";
const layout = "_layout_1ahxr_310";
var scss$1 = {
  fontS: fontS$1,
  fontM: fontM$1,
  fontL: fontL$1,
  ...
  "backgroundColor--primary": "_backgroundColor--primary_1ahxr_294",
  "backgroundColor--text100": "_backgroundColor--text100_1ahxr_298",
  "color--primary": "_color--primary_1ahxr_302",
  "color--text100": "_color--text100_1ahxr_306",
  layout
};
const Layout = (_ia) => {
